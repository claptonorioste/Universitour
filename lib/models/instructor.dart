class Instructor {
  ...
  Instructor({this.room_id,this.namenum, this.roomNum,this.instructor, this.floor, this.roomName,
  ...
  Instructor.fromDb(Map<String, dynamic> map)
      : room_id = int.parse(map['room_id']),
        namenum = map['instructor'],
        roomNum = map['roomNum'],
        floor = map['floor'],
